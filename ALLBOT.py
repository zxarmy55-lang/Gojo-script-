...
# Default messages
NON_SUDO_MSG = "❌𝐆𝐀𝐑𝐈𝐁 𝐆𝐎𝐉𝐎 𝐏𝐀𝐏𝐀 𝐉𝐈𝐓𝐍𝐀 𝐀𝐔𝐊𝐀𝐓 𝐁𝐀𝐍𝐀 👺 !"
...
def owner_only(func):
    async def wrapper(update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        await update.message.reply_text(" 𝐏𝐇𝐀𝐋𝐄 𝐓𝐄𝐑𝐄 𝐁𝐀𝐀𝐏 𝐒𝐄 𝐒𝐔𝐃𝐎 𝐊𝐈 𝐁𝐇𝐈𝐊 𝐌𝐀𝐍𝐆 ")
    return wrapper
...
"""
        ...
        await update.message.reply_text(" 𝗚𝗢𝗝𝗢 𝗣𝗔𝗣𝗔 𝗦𝗘 𝗦𝗨𝗗𝗢 𝗞𝗜 𝗕𝗛𝗜𝗞 𝗠𝗔𝗡𝗚 𝗥𝗡𝗗𝗜 𝗞𝗘 😆")
